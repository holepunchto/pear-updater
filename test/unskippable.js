...
test('should follow unskippable updates', async function (t) {
  ...
  let u = new Updater(clone, { directory, host: 'universal-universal' })
  ...
  u = new Updater(clone, { directory, host: 'universal-universal', checkout: checkout1 })
  await eventFlush()
  await u.update()
  await u.applyUpdate()
  ...
  u = new Updater(clone, { directory, host: 'universal-universal', checkout: checkout2 })
  await eventFlush()
  await u.update()
  await u.applyUpdate()
  ...
  u = new Updater(clone, { directory, host: 'universal-universal', checkout: checkout3 })
  await eventFlush()
  await u.update()
  await u.applyUpdate()

...
test('should follow unskippable updates', async function (t) {
  ...
  unskippables.push(drive.core.length)
  await drive.put('/checkout.js', 'console.log("hello")')
  unskippables.push(drive.core.length)
  await drive.put('/checkout.js', 'console.log("hello")\nconsole.log("world")')
  await drive.put('/checkout.js', 'console.log("hello")\nconsole.log("world")\nconsole.log("universe")')
  unskippables.push(drive.core.length)
  await drive.put('/package.json', JSON.stringify({ main: 'own-main.js', pear: { stage: { unskippableUpdates: unskippables } } }))
  ...
  t.is(checkout1.length, unskippables[0], 'Checkout matches unskippable')
  ...
  t.is(checkout2.length, unskippables[1], 'Checkout matches unskippable')
  ...
  t.is(checkout3.length, unskippables[2], 'Checkout matches unskippable')
